...
chromatic_description = "The algorithm parses lines from a file containing nucleotide sequences into triplets. Each individual \
                        nucleotide, as well as nucleotide pairs and triplets composed of a single repeated nucleotide, is assigned \
                        a note from the chromatic scale, which consists of twelve notes."
...
def get_mapping_chromatic():
    """
    Returns mapping of chromatic algorithm.
    """
