...
diatonic_description = "The algorithm parses lines from a file containing nucleotide sequences into pairs. Each individual \
...
def get_mapping_diatonic():
    """
    Returns mapping of diatonic algorithm.
    """
    return diatonic_mapping